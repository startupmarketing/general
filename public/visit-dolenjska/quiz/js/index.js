...
class App extends React.Component {
  ...
  sendData(data){
    axios.post( URL + '/visit-dolenjska/api/quiz-broadcast-slo', {data, broadcast_data})
  ...
  async handleClick(anwser) {
    ...
    if(anwser === "top"){
      ...
      data[this.count].anwser = data[this.count].top;
      console.log(data[this.count].anwser);

    }else{

      data[this.count].anwser = data[this.count].bottom;
      console.log(data[this.count].anwser);
    ...
    return (
      <div>
        <div className="main-container">
            ...
            <p className="page__desc">Izberi in klikni na fotografijo. </p>
            </div>

            <div>

                <div value={data[this.count].top} onClick={() => this.handleClick("top")} className="top-image">
                ...
                <div className="separator-wrapper">
                    <div className="separator"><img src={"/public/visit-dolenjska/quiz/images/i_emoji.JPG"} alt="" height="20" width="20"/></div>
                </div>
                
                <div value={data[this.count].bottom} onClick={() => this.handleClick("bottom")} className="bottom-image">
